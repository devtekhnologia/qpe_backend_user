...
//   addRole: async (req: Request): Promise<any> => {
//     try {
//       const { name } = req.body;
...
//     } catch (error) {
//       const message = `"Error adding roles: " ${error}`;
//       return ServiceResponse.internalServerError(message);
//     }
//   },
...
//         return ServiceResponse.notFound(res, "No roles found");
//       }
  
//       return ServiceResponse.success("Roles fetched successfully", allRoles);
//     } catch (error: any) {
//       const message = `Error fetching roles: ${error.message}`;
//       return ServiceResponse.internalServerError(message);
//     }
//   }
